var IndexPage = Ext.extend(Ext.Viewport, {
	top : {
            ...
            html: '<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" style="table-layout:fixed;">'+
			  '<tr><td width="254px" style="background:url(../../img/top_center.jpg)"><img src="../../img/logo.png" /></td>'+
	...
	center:{
			...
			margins: '0 5 5 0',
			border: false,
			html : '<iframe id="main" src="" width="100%" height="100%" scrolling="auto" frameborder="0" ></iframe>'
	},
	south : {
			region : 'south',
			height : 30,
			tbar : [{
						...
						iconCls : 'btn-logout',
						handler : function() {
							Ext.MessageBox.confirm('确认提示','是否退出考勤系统？',function(c){
							if(c=="yes"){
								App.Logout();
							}
							}
