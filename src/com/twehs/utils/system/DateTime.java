...
public class DateTime {
    ...
    public static String getYearMonth(){
    	 Calendar c = Calendar.getInstance(TimeZone.getTimeZone("GMT+08:00"));    //获取东八区时间
		  ...
		  String month =String.valueOf(c.get(Calendar.MONTH) + 1<10?"0"+(c.get(Calendar.MONTH) + 1):c.get(Calendar.MONTH) + 1);    //获取月份，0表示1月份
		  
		  return year + "-" + month;
    }
    /**
     * startmonth转换为YYYY-MM-01，
     * 返回date类型
     * */
